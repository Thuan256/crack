    ...
    })(
        {
                ...
                function (t, i, n) {
                    ...
                    n.encode = function (t, i, n) {
                        ...
                        return (
                            ...
                            e
                                ? (u && e.push(String.fromCharCode.apply(String, s.slice(0, u))), e.join(""))
                ...
                function (t, i, n) {
                    ...
                    ((i.exports = r).prototype.on = function (t, i, n) {
                        ...
                        (r.prototype.off = function (t, i) {
                            ...
                            else for (var n = this.t[t], r = 0; r < n.length; ) n[r].fn === i ? n.splice(r, 1) : ++r;
                            return this;
                        }),
                        ...
                        (n.write = function (t, i, n) {
                            for (var r, e, s = n, u = 0; u < t.length; ++u)
                                (r = t.charCodeAt(u)) < 128
                                    ...
                                    : (r < 2048
                                          ? (i[n++] = (r >> 6) | 192)
                                          : (55296 == (64512 & r) && 56320 == (64512 & (e = t.charCodeAt(u + 1)))
                                                ? (++u,
                                                  (i[n++] =
                                                      ((r = 65536 + ((1023 & r) << 10) + (1023 & e)) >> 18) | 240),
                                                  (i[n++] = ((r >> 12) & 63) | 128))
                                                : (i[n++] = (r >> 12) | 224),
                                            (i[n++] = ((r >> 6) & 63) | 128)),
                                      (i[n++] = (63 & r) | 128));
                ...
                function (t, i, n) {
                    ...
                    function u(t, i, n, r) {
                        ...
                        if (i.resolvedType)
                            if (i.resolvedType instanceof l) {
                                t("switch(d%s){", r);
                                for (var s = i.resolvedType.values, u = Object.keys(s), o = 0; o < u.length; ++o)
                                    s[u[o]] !== i.typeDefault ||
                                        e ||
                                        (t("default:")('if(typeof(d%s)==="number"){m%s=d%s;break}', r, r, r),
                                        i.repeated || t("break"),
                                        (e = !0)),
                                        t("case%j:", u[o])("case %i:", s[u[o]])("m%s=%j", r, s[u[o]])("break");
                                t("}");
                            } else
                            ...
                            switch (i.type) {
                                ...
                                case "fixed64":
                                case "sfixed64":
                                    t("if(util.Long)")("(m%s=util.Long.fromValue(d%s)).unsigned=%j", r, r, h)(
                    ...
                    (n.fromObject = function (t) {
                        ...
                        (n.toObject = function (t) {
                            ...
                            for (
                                var n = d.codegen(["m", "o"], t.name + "$toObject")("if(!o)")("o={}")("var d={}"),
                                    r = [],
                                    e = [],
                                    s = [],
                                    u = 0;
                            ...
                            if (s.length) {
                                for (n("if(o.defaults){"), u = 0; u < s.length; ++u) {
                                    ...
                                    h.resolvedType instanceof l
                                        ...
                                        : h.bytes
                                        ? ((o = "[" + Array.prototype.slice.call(h.typeDefault).join(",") + "]"),
                                          n(
                            ...
                            for (var c = !1, u = 0; u < i.length; ++u) {
                                ...
                                h.map
                                    ...
                                    : (n("if(m%s!=null&&m.hasOwnProperty(%j)){", f, h.name),
                                      v(n, h, a, f),
                                      h.partOf && n("if(o.oneofs)")("d%s=%j", d.safeProp(h.partOf.name), h.name)),
                                    n("}");
                            }
                            return n("return d");
                        });
            ...
            12: [
                function (t, i, n) {
                    i.exports = function (t) {
                        var i = f.codegen(["r", "l"], t.name + "$decode")("if(!(r instanceof Reader))")(
                            "r=Reader.create(r)"
                        )(
            ...
            13: [
                function (t, i, n) {
                    i.exports = function (t) {
                        for (
                            var i,
                                n = a.codegen(["m", "w"], t.name + "$encode")("if(!w)")("w=Writer.create()"),
                            ...
                            (i = "m" + a.safeProp(s.name)),
                                s.map
                                    ? (n(
                                      ...
                                      h === g
                                          ? n("types[%i].encode(%s[ks[i]],w.uint32(18).fork()).ldelim().ldelim()", u, i)
                                    ...
                                    ? (n("if(%s!=null&&%s.length){", i, i),
                                      s.packed && c.packed[o] !== g
                                          ...
                                          : (n("for(var i=0;i<%s.length;++i)", i),
                                            h === g
                                                ? l(n, s, u, i + "[i]")
                                                : n("w.uint32(%i).%s(%s[i])", ((s.id << 3) | h) >>> 0, o, i)),
                                      n("}"))
                                    : (s.optional && n("if(%s!=null&&Object.hasOwnProperty.call(m,%j))", i, s.name),
                                      h === g
                                          ? l(n, s, u, i)
                                          : n("w.uint32(%i).%s(%s)", ((s.id << 3) | h) >>> 0, o, i));
                        }
                        return n("return w");
                    };
                    var f = t(14),
                    ...
                    function s(t, i, n, r, e, s) {
                        ...
                        if (
                            ...
                            for (var u = Object.keys(i), o = 0; o < u.length; ++o)
                                "number" == typeof i[u[o]] && (this.valuesById[(this.values[u[o]] = i[u[o]])] = u[o]);
                    }
            ...
            20: [
                function (t, i, n) {
                    ...
                    function r(t, i, n, r, e, s, u, o, h) {
                        if (
                            (c.isObject(e) ? ((u = e), (e = s = g)) : c.isObject(s) && ((u = s), (s = g)),
                            i !== g && !c.isString(i))
                        )
                ...
                function (t, i, n) {
                    ...
                    (a.fromJSON = function (t, i) {
                        ...
                        (a.prototype.lookup = function (t, i, n) {
                            if (
                                ("boolean" == typeof i ? ((n = i), (i = g)) : i && !Array.isArray(i) && (i = [i]),
            ...
            23: [
                function (t, i, n) {
                    ...
                    var e = t(22),
                        ...
                        s = t(33);
                    function u(t, i, n, r) {
                        if ((Array.isArray(i) || ((n = i), (i = g)), e.call(this, t, n), i !== g && !Array.isArray(i)))
            ...
            26: [
                function (t, i, n) {
                                    ...
                                    if ((b.isString(i) && "{" == (i[0] || "") && (i = JSON.parse(i)), b.isString(i))) {
                                        ...
                                        if (r.weakImports)
                                            for (e = 0; e < r.weakImports.length; ++e)
                                                (n = f(r.weakImports[e]) || u.resolvePath(t, r.weakImports[e])) &&
                                                    a(n, !0);
                    ...
                    function c(t, i) {
                        ...
                        if (r)
                            return (
                                (((n = new s(i.fullName, i.id, i.type, i.rule, g, i.options)).declaringField =
                                    i).extensionField = n),
                                r.add(n),
                                1
                            );
            ...
            29: [
                function (t, i, n) {
                    ...
                    (((r.prototype = Object.create(o.EventEmitter.prototype)).constructor = r).prototype.rpcCall =
                            ...
                            set: function (t) {
                                for (
                                    var i = t.prototype,
                                        n =
                                            (i instanceof e ||
                                                (((t.prototype = new e()).constructor = t), d.merge(t.prototype, i)),
                ...
                function (t, i, n) {
                    ...
                    (e.fromHash = function (t) {
                        return "\0\0\0\0\0\0\0\0" === t
                            ? s
                            : new e(
                                  (u.call(t, 0) | (u.call(t, 1) << 8) | (u.call(t, 2) << 16) | (u.call(t, 3) << 24)) >>>
                                      0,
                                  (u.call(t, 4) | (u.call(t, 5) << 8) | (u.call(t, 6) << 16) | (u.call(t, 7) << 24)) >>>
                                      0
                              );
                    }),
                    ...
                    function s(t) {
                        ...
                        return (
                            (n.prototype = Object.create(Error.prototype, {
                                constructor: { value: n, writable: !0, enumerable: !1, configurable: !0 },
                                name: {
                                    get() {
                                        return t;
                                    },
            ...
            36: [
                function (t, i, n) {
                    i.exports = function (t) {
                        var i = h.codegen(["m"], t.name + "$verify")('if(typeof m!=="object"||m===null)')(
                                "return%j",
                                "object expected"
                            ),
                            n = t.oneofsArray,
                            ...
                            u.optional && i("if(%s!=null&&m.hasOwnProperty(%j)){", o, u.name),
                                u.map
                                    ...
                                    : (u.partOf &&
                                          ...
                                          1 === r[u.partOf.name] &&
                                              i("if(p%s===1)", s)("return%j", u.partOf.name + ": multiple values"),
                                          (r[u.partOf.name] = 1),
                                          i("p%s=1", s)),
                                      c(i, u, e, o)),
                                u.optional && i("}");
            ...
            38: [
                function (t, i, n) {
                    ...
                    function b(t, i, n) {
                        for (; t.hi; )
                            (i[n++] = (127 & t.lo) | 128), (t.lo = ((t.lo >>> 7) | (t.hi << 25)) >>> 0), (t.hi >>>= 7);
                    ...
                    (a.prototype.bytes = function (t) {
                        var i,
                            n = t.length >>> 0;
                        return n
                            ? (e.isString(t) && ((i = a.alloc((n = u.length(t)))), u.decode(t, i, 0), (t = i)),
...
const spotifyJson = {
    ...
    nested: {
        ...
        AccountAttributesResponse: {
            fields: { accountAttributes: { keyType: "string", type: "AccountAttribute", id: 1 } },
        },
        AccountAttribute: {
...
if (resStatus !== 200) {
    ...
    if (url.includes("bootstrap/v1/bootstrap") && method === postMethod) {
        ...
        accountAttributesMapObj =
            bootstrapResponseObj.ucsResponseV0.success.customization.success.accountAttributesSuccess.accountAttributes;
